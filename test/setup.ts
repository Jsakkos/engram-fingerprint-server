...
// applyD1Migrations in @cloudflare/vitest-pool-workers 0.12.x expects
// D1Migration[] (not a directory string). We inline the migration SQL here
// so the setup works without Node.js fs access in the Worker runtime.
const MIGRATIONS = [
  {
    name: "001_initial",
    queries: [
